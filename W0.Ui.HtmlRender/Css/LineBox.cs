...
namespace W0.Ui.HtmlRender.Css
{
    ...
    internal class LineBox
    {
        ...
        internal void DrawRectangles(Graphics g)
        {
            foreach (var b in Rectangles.Keys)
            {
                ...
                g.FillRectangle(new SolidBrush(Color.FromArgb(50, Color.Black)),
                    System.Drawing.Rectangle.Round(Rectangles[b]));
                g.DrawRectangle(Pens.Red, System.Drawing.Rectangle.Round(Rectangles[b]));
            }
        }
        ...
        internal void SetBaseLine(Graphics g, Box b, float baseline)
        {
        ...
        /// </summary>
        public List<Box> RelatedBoxes { get; }
        ...
        /// </summary>
        public Dictionary<Box, RectangleF> Rectangles { get; }
